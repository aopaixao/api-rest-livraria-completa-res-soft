...
import br.com.residencia.api_livraria.security.service.UserDetailsServiceImpl;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/editoras/**", "/livros/**", "/autores/**").hasAnyRole("USER", "ADMIN") //autoriza o acesso a rotas por perfis
